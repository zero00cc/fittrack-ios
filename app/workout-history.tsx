...
const cal = StyleSheet.create({
  ...
  cell:       { flex: 1, height: 40, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  ...
  prStar:     { width: 5, height: 5, borderRadius: 2.5, backgroundColor: ACCENT, position: 'absolute', bottom: 2 },
